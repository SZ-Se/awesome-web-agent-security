...
|---|---|---|---:|---|---|
| [InjecAgent: Benchmarking Indirect Prompt Injections in Tool-Integrated Large Language Model Agents](https://aclanthology.org/2024.findings-acl.624/) | ACL Findings 2024 | Benchmark | ★★★★☆ | Context / Data Attacks | `indirect prompt injection`, `tool-integrated agents`, `benchmark`, `data exfiltration` |
| [AgentDojo: A Dynamic Environment to Evaluate Prompt Injection Attacks and Defenses for LLM Agents](https://proceedings.neurips.cc/paper_files/paper/2024/hash/97091a5177d8dc64b1da8bf3e1f6fb54-Abstract-Datasets_and_Benchmarks_Track.html) | NeurIPS 2024 | Benchmark | ★★★★☆ | Security Evaluation | `agent security`, `benchmark`, `indirect prompt injection`, `tool execution` |
| [Formalizing and Benchmarking Prompt Injection Attacks and Defenses](https://www.usenix.org/conference/usenixsecurity24/presentation/liu-yupei) | USENIX Security 2024 | Benchmark / Framework | ★★★☆☆ | Prompt Injection Foundations | `prompt injection`, `formalization`, `benchmark`, `defense` |
| [The Task Shield: Enforcing Task Alignment to Defend Against Indirect Prompt Injection in LLM Agents](https://aclanthology.org/2025.acl-long.1435/) | ACL 2025 | Defense | ★★★★☆ | Defenses | `defense`, `task alignment`, `indirect prompt injection`, `runtime checking` |
| [WebInject: Prompt Injection Attack to Web Agents](https://aclanthology.org/2025.emnlp-main.104/) | EMNLP 2025 | Attack | ★★★★★ | Observation / Environment Attacks | `web agent`, `visual prompt injection`, `MLLM`, `adversarial perturbation` |
| The Dangers of Indirect Prompt Injection Attacks on LLM-based Autonomous Web Navigation Agents | EMNLP System Demonstrations 2025 | Attack / Demo | ★★★★☆ | Observation / Environment Attacks | `web navigation`, `indirect prompt injection`, `BrowserGym`, `credential exfiltration` |
| [MELON: Provable Defense Against Indirect Prompt Injection Attacks in AI Agents](https://proceedings.mlr.press/v267/zhu25z.html) | ICML 2025 | Defense | ★★★★☆ | Defenses | `defense`, `masked re-execution`, `indirect prompt injection`, `causal runtime defense` |
| Cloak, Honey, Trap | USENIX Security 2025 | Defense / Deception | ★★★☆☆ | Adversarial Environments | `deception`, `honey tokens`, `traps`, `malicious agents` |
| [Benchmarking Web Agent Safety under E-commerce Deceptive Interfaces](https://aclanthology.org/2026.acl-long.1009/) | ACL 2026 | Benchmark | ★★★★★ | Observation / Environment Attacks | `web agent`, `deceptive interface`, `e-commerce`, `benchmark` |
...
| [AttriGuard: Defeating Indirect Prompt Injection in LLM Agents via Causal Attribution of Tool Invocations](https://www.usenix.org/conference/usenixsecurity26/presentation/he-yu) | USENIX Security 2026 | Defense | ★★★★☆ | Defenses | `defense`, `causal attribution`, `tool invocation`, `indirect prompt injection` |
